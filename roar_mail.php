...
<tr><td style="padding:0 50px;text-align:center" align="center"><p style="color:#7f8c8d;font-size:16px;line-height:140%;margin:0 0 20px">Your friend <b>raghunadh2006</b> just Roared at you via Sports Lion.Sports Lion is a social sports gaming platform where you can Roar against other sports lovers and win prizes. To respond to your friend’s Roar, please create an account by following the button below. It’s completely free!</p></td></tr>
<tr><td style="padding:0 50px;text-align:center" align="center"><table align="center" width="500px">
...
<td style="color:#7f8c8d;padding:0 0 30px;text-align:center;vertical-align:top" align="center" valign="top">
<div style="font-size:18px">Roar fee: </div>
