...
<?php /*
	<header class="page-header">
		<h1 class="page-title" style="font-size:15px;float:right;"><a href="http://sportslionleaderboard.com/basketball.php?numb=10">Top 10</a>  |  <a href="http://sportslionleaderboard.com/basketball.php?numb=20">Top 20</a>  |  <a href="http://sportslionleaderboard.com/basketball.php?numb=30">Top 30</a></h1>
	</header><!-- .page-header --> */ ?>
	<div class="page-content">
		<center>
			<h2>BasketBall Top Lions</h2>
...
) as point where basketball_won>basketball_lost and (user_id != 5 and user_id != 11 and user_id!= 13 and user_id != 8 and user_id != 12 and user_id != 25) order by net_basketball_points desc limit '".$numb."'";
