...
<?php /*
	...
	<header class="page-header">
		 <h1 class="page-title" style="font-size:15px;float:right;"><a href="http://sportslionleaderboard.com/am-football.php?numb=10">Top 10</a>  |  <a href="http://sportslionleaderboard.com/am-football.php?numb=20">Top 20</a>  |  <a href="http://sportslionleaderboard.com/am-football.php?numb=30">Top 30</a></h1> 
	</header><!-- .page-header -->*/ ?>
	<div class="page-content">
		<center>
			<h2>American Football Top Lions</h2>
...
$query = "select username,amer_football_won-amer_football_lost as net_amer_football_points from 
(
...
) as point where amer_football_won>amer_football_lost and (user_id != 5 and user_id != 11 and user_id!= 13 and user_id != 8 and user_id != 12 and user_id != 25) order by net_amer_football_points desc limit '".$numb."'";
