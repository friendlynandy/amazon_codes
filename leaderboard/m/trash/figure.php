...
<ul>
   ...
   <li class='active'><a href='figure.php'><span>Fig-Skating</span></a></li>
...
) as point where fgr_sktng_won>fgr_sktng_lost and (user_id != 5 and user_id != 11 and user_id!= 13 and user_id != 8 and user_id != 12 and user_id != 25) order by net_fgr_sktng_points desc limit 10';
