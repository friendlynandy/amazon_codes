...
<ul>
   ...
   <li class='active'><a href='afootball.php'><span>Am-Football</span></a></li>
...
) as point where amer_football_won>amer_football_lost and (user_id != 5 and user_id != 11 and user_id!= 13 and user_id != 8 and user_id != 12 and user_id != 25) order by net_amer_football_points desc limit 10';
