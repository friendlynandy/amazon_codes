...
<ul>
   ...
   <li class='active'><a href='basket.php'><span>Basketball</span></a></li>
   <li><a href='cricket.php'><span>Cricket</span></a></li>
</ul>
</div>
<div class="box">
<?php
...
) as point where basketball_won>basketball_lost and (user_id != 5 and user_id != 11 and user_id!= 13 and user_id != 8 and user_id != 12 and user_id != 25) order by net_basketball_points desc limit 10';
