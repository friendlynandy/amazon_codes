...
<ul>
   ...
   <li class='active'><a href='efootball.php'><span>Euro-Football</span></a></li>
...
) as point where euro_football_won>euro_football_lost and (user_id != 5 and user_id != 11 and user_id!= 13 and user_id != 8 and user_id != 12 and user_id != 25) order by net_euro_football_points desc limit 10';
