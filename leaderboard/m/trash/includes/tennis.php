...
<div class="logo"><a href="index.php"><img src="logo.png" alt="SporsLion Logo" style="margin:0 -106px 0;position:absolute;top:-22px;left:51%;z-index:100px;"></a></div>
<div id=header1><h1>LEADERBOARD</h1></div>
<div id='cssmenu'>
<ul>
   <li><a href='index.php'><span>Overall</span></a></li>
   <li class='active'><a href='tennis.php'><span>Tennis</span></a></li>
...
) as point where  (user_id != 5 and user_id != 11 and user_id!= 13 and user_id != 8 and user_id != 12 and user_id != 25) order by net_tennis_points desc limit 10';
$result = pg_query($query) or die('Query failed: ' . pg_last_error());

// Printing results in HTML
echo "<table>";
echo "<TH>Username  </TH><TH>  Points</TH>\n";
